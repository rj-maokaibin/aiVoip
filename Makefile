...
ai-model-eval:
	...
	PYTHONPATH=backend:. python tools/ai_eval_runner.py --dataset "$(AI_EVAL_DATASET)" --mode "$(if $(AI_EVAL_MODE),$(AI_EVAL_MODE),fixture)" --out validation/ai_model_eval.json
