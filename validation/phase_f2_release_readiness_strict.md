...
- PASS: 25 / BLOCKED: 12 / UNVERIFIED: 3 / FAIL: 0
...
| PRODUCTION_HARDENING_CONTRACT | PASS | STATIC | yes | Validated by the exact-source Phase F2 static-gate artifact. |
...
| DOCKER_FULLSTACK_RUNTIME | UNVERIFIED | RUNTIME | yes | Docker full-stack runtime is not verified for this source: evidence artifact missing: /mnt/data/voip-ai-v1-production-hardening-f2/validation/fullstack_result.json |
...
| FRONTEND_PRODUCTION_BUILD | UNVERIFIED | BUILD | yes | Frontend production build is not verified for this source: evidence artifact missing: /mnt/data/voip-ai-v1-production-hardening-f2/validation/frontend_build_runtime.json |
...
- **DOCKER_FULLSTACK_RUNTIME** — UNVERIFIED: Docker full-stack runtime is not verified for this source: evidence artifact missing: /mnt/data/voip-ai-v1-production-hardening-f2/validation/fullstack_result.json
...
- **FRONTEND_PRODUCTION_BUILD** — UNVERIFIED: Frontend production build is not verified for this source: evidence artifact missing: /mnt/data/voip-ai-v1-production-hardening-f2/validation/frontend_build_runtime.json
