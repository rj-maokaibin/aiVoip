...
class AIDiagnosticCycle(Base):
    ...
    __table_args__ = (
        ...
        CheckConstraint("formal_result_changed = false", name="ck_ai_diagnostic_cycle_no_formal_result_change"),
        CheckConstraint("dispatch_attempted = false", name="ck_ai_diagnostic_cycle_no_ai_dispatch_attempt"),
        CheckConstraint("dispatch_allowed = false", name="ck_ai_diagnostic_cycle_no_ai_dispatch_authority"),
