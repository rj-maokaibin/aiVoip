...
celery_app = Celery(
    ...
    include=[
        "app.workers.collector_tasks",
        "app.workers.packet_tasks",
        "app.workers.pcm_tasks",
        "app.workers.media_tasks",
        "app.workers.attachment_tasks",
        "app.workers.diagnosis_tasks",
        "app.workers.evidence_report_tasks",
        "app.workers.evidence_retention_tasks",
        "app.workers.feishu_evidence_report_task",
        "app.workers.feishu_document_acl_task",
        "app.workers.reproduction_tasks",
        "app.workers.reproduction_event_tasks",
        "app.workers.device_provision_task",
